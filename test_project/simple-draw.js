...
function initialize() {
  ...
  goog.events.listen(
    canvas, goog.events.EventType.MOUSEDOWN, onMouseDownCanvas);
  ...
  selectionModel.setSelectedItem(
  ...
  goog.events.listen(
    strokeButton, goog.ui.Component.EventType.ACTION, onChangeStrokeColor);

  var fillButton = toolbar.getChild('toolbar-color-fill');
  fillButton.setSelectedColor(currentFill.getColor());
  goog.events.listen(
    fillButton, goog.ui.Component.EventType.ACTION, onChangeFillColor);
}
